 ...
 */
class Media extends \DV\EcomBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DV\\EcomBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'DV\\EcomBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'DV\\EcomBundle\\Entity\\Media' . "\0" . 'alt'];
        }
