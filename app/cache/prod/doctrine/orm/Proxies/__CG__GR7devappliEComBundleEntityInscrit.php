 ...
 */
class Inscrit extends \GR7dev\appliEComBundle\Entity\Inscrit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\Inscrit' . "\0" . 'id', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\Inscrit' . "\0" . 'nom', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\Inscrit' . "\0" . 'prenom', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\Inscrit' . "\0" . 'etat', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\Inscrit' . "\0" . 'adresse');
        }
