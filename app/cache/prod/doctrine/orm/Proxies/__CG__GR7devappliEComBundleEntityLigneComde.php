 ...
 */
class LigneComde extends \GR7dev\appliEComBundle\Entity\LigneComde implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\LigneComde' . "\0" . 'id', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\LigneComde' . "\0" . 'produit', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\LigneComde' . "\0" . 'quantite', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\LigneComde' . "\0" . 'prix');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneComde $proxy) {
