 ...
 */
class PrixProduit extends \GR7dev\appliEComBundle\Entity\PrixProduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\PrixProduit' . "\0" . 'id', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\PrixProduit' . "\0" . 'datedeb', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\PrixProduit' . "\0" . 'prix', '' . "\0" . 'GR7dev\\appliEComBundle\\Entity\\PrixProduit' . "\0" . 'produit');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrixProduit $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setProduit(\GR7dev\appliEComBundle\Entity\Produit $produit = NULL)
    {
