...
use DV\EcomBundle\Form\CategoriesType;
...
class CategoriesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EcomBundle:Categories')->findAll();

        return $this->render('EcomBundle:Administration:Categories/layout/index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EcomBundle:Administration:Categories/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EcomBundle:Categories')->find($id);
        ...
        return $this->render('EcomBundle:Administration:Categories/layout/show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcomBundle:Administration:Categories/layout/edit.html.twig', array(
            'entity'      => $entity,
