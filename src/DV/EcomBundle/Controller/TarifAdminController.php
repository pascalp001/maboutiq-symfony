...
use DV\EcomBundle\Form\TarifType;
...
class TarifAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcomBundle:Administration:Tarif/layout/index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EcomBundle:Administration:Tarif/layout/new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EcomBundle:Administration:Tarif/layout/edit.html.twig', array(
            'entity'      => $entity,
