 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="DV\EcomBundle\Entity\VendeurRepository")
 */
class Vendeur
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="comptebanc", type="string", length=255)
     */
    private $comptebanc;
     ...
     * @var string
     *
     * @ORM\Column(name="syssecur", type="string", length=255)
     */
    private $syssecur;
     ...
     * @var string
     *
     * @ORM\Column(name="nombqsecur", type="string", length=255)
     */
    private $nombqsecur;
     ...
     * @var string
     *
     * @ORM\Column(name="urlbq", type="string", length=255)
     */
    private $urlbq;
     ...
     * @var string
     *
     * @ORM\Column(name="numerocnil", type="string", length=255)
     */
    private $numerocnil;
     ...
     * @var string
     *
     * @ORM\Column(name="greffe", type="string", length=255)
     */
    private $greffe;
